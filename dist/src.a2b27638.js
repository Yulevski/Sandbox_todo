...
var onClickAdd = function onClickAdd() {
  ...
  var inputText = document.getElementById("add-text").value; //入力された値を取得
  document.getElementById("add-text").value = ""; //inputテキストの内容を空に
  createIncompleteList(inputText);
};
document.getElementById("add-button").addEventListener("click", function () {
  return onClickAdd();
}); //add-bittonがクリックされたとき関数onclickAddを実行
...
var createIncompleteList = function createIncompleteList(text) {
  ...
  //li tag 生成
  var li = document.createElement("li"); //li tag 生成
  li.innerText = text; //liの中にinputの内容が取得される
  //console.log(li);

  //button(complete)タグ生成
  var completeButton = document.createElement("button"); //<button>要素作成
  ...
  completeButton.addEventListener("click", function () {
    ...
    backButton.addEventListener("click", function () {
      ...
      var deleteTarget = backButton.parentNode; //backbuttonのdiv要素取得
  ...
  //button(delete)タグ生成
  var deleteButton = document.createElement("button"); //<button>要素作成
